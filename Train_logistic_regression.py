...
for train_index, test_index in CV.split(X, y):
    ...
    #model_noreg = LogisticRegression(penalty="l2", solver='lbfgs').fit(X_train, y_train)
    ...
    model_rlr = LogisticRegression(penalty='l2', C=1 / lambdas)
    model_rlr.fit(X_train, y_train)
